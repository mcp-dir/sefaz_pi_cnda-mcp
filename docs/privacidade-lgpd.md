...
SEFAZ PI: Solicitar Certidão Negativa da Dívida Ativa (CNDA) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_pi_cnda@mcp.ai](mailto:sefaz_pi_cnda@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
